...
const releasesUrl = 'https://github.com/PanterSoft/CANtracer/releases/latest';
const _apiUrl = 'https://api.github.com/repos/PanterSoft/CANtracer/releases/latest';

/// Tag of a newer GitHub release, or null when up to date, offline, or rate-limited.
Future<String?> checkForUpdate() async {
  final client = HttpClient()..connectionTimeout = const Duration(seconds: 5);
  try {
    final res = await (await client.getUrl(Uri.parse(_apiUrl))).close();
